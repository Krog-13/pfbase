...
from .document.urls import dcm_router, rct_router, dcm_idc_router, riv_router, dcm_his_router, rct_urlpatterns, business_router_urlpatterns
...
urlpatterns += elm_urlpatterns + rct_urlpatterns + doc_urlpatterns + user_urlpatterns + common_urlpatterns + business_router_urlpatterns
